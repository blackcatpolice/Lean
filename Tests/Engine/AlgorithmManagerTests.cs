...
namespace QuantConnect.Tests.Engine
{
    ...
    public class AlgorithmManagerTests
    {
        ...
        public class NullAlphaHandler : IAlphaHandler
        {
            ...
            public void Initialize(AlgorithmNodePacket job, IAlgorithm algorithm, IMessagingHandler messagingHandler, IApi api, IOrderEventProvider orderEventProvider)
            {
            }
